...
ROBOTIQ_2F85_CALIBRATION_PROFILE = (
    ...
    / "calibrations"
    / "candidate"
    / "graspnet-eef-robotiq-2f85.json"
)
...
_CALIBRATION_RULES = (
    {
        ...
        "environment_contains": ("libero", "sim"),
    ...
    },
    {
        ...
        "profile_path": ROBOTIQ_2F85_CALIBRATION_PROFILE,
        "environment_contains": ("ur5e", "robotiq", "real"),
        "robot_models": ("ur5e", "ur5", "universal robots ur5e"),
        "gripper_models": ("robotiq2f85", "robotiq", "robotiq 2f-85", "2f85"),
        "grasp_frames": ("graspnet", "anygrasp"),
    },
)
