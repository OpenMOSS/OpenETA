...
WRIST_CAMERA = CameraConfig(
    ...
    height=720,
    fps=30,
    serial=os.environ.get("OPENETA_REALSENSE_SERIAL") or None,
    depth_enabled=True,
...
UR5E = RobotConfig(
    name="ur5e",
    ip=os.environ.get("OPENETA_UR5E_IP", ""),
    dof=6,
...
def build_env(task: str = "") -> RealRobotEnv:
    if not UR5E.ip:
        raise RuntimeError("Set OPENETA_UR5E_IP to the robot controller address.")
