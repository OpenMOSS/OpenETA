...
def health_payload() -> dict[str, Any]:
    """Describe the exact backend behind this network endpoint."""
    ...
    service_info = getattr(_BACKEND, "service_info", None)
    return {
        "ok": True,
        "server": "anygrasp",
        "backend_configured": True,
        "service": service_info() if callable(service_info) else {},
    }
