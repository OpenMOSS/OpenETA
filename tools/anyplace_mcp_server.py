...
from tools.anyplace_core import DEFAULT_DEPTH_TRUNCATION  # noqa: E402
...
def predict_placement(
    ...
    frame. Valid depth is truncated at 2 metres by default. The object and
    ...
    Args:
        ...
        selected_grasp: One model-native AnyGrasp candidate in
            ...
            this MCP call.
        depth_truncation: Optional per-call far cut in metres. Points beyond
            this range are dropped before inference, overriding the server
            default for this call only. Use a sensor/scene-specific value
            (e.g. ~1.5 for D435, ~2.0 for L515).
...
def main() -> int:
    ...
    parser.add_argument("--depth-truncation", type=float, default=DEFAULT_DEPTH_TRUNCATION)
